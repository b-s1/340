module.exports = function(){
 ...
 function getLocations(res, mysql, context, complete){
        mysql.pool.query("SELECT loc_id as id, loc_name AS name, loc_type AS type FROM Houses", function(error, results, fields){
            if(error){
